...
export default function TextCompare() {
  ...
  return (
    <>
      <NavigationBar style={{  marginLeft: '10px', marginBottom: '20px' }} />

      <div style={{ marginLeft: '10px', marginRight: '10px', marginTop: '20px' }} className="flex flex-col min-h-screen px-4 md:px-12 py-8 mb-20">
        {isAlertVisible && (<AlertBanner title="Both text fields are required.....!" color="warning" />)}
        ...
        {isVisible && (
          <div className="flex flex-row gap-4 w-full justify-center mt-12">
            <div className="w-1/2">
              <label style={{marginBottom: '15px' }} className="block text-sm font-medium font-bold">Original Text (Compared)</label>  {/* Increased margin-bottom */}
              <div className="bg-gray-100 h-60 overflow-auto" style={{ whiteSpace: 'pre-wrap' }}>
                {renderDiffStream(diffMap.text1)}
              </div>
            </div>
            <div className="w-1/2">
              <label style={{marginBottom: '15px' }} className="block text-sm font-medium">Changed Text (Compared)</label>  {/* Increased margin-bottom */}
              <div className="bg-gray-100 h-60 overflow-auto" style={{ whiteSpace: 'pre-wrap' }}>
